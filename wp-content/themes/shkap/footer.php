        ...
        <footer id="footer">
            <div class="responsive-container">
                <div class="footer_tools layout">
                    ...
                    <nav class="foot_menu">
                        <?php wp_nav_menu( array( 'theme_location' => 'footer_menu', 'menu_class' => 'foot_menu', 'menu_id' => '', 'container' => '' ) ); ?>
                    </nav>
                ...
                <div class="auth layout">
                    <p class="copy">&copy;2015 ЧУП &laquo;Книжный шкап&raquo; в торговом реестре с 01.01.2015</p>
                    <span class="diz">
        ...
        <div>
            <div>
                <div class="register-box transition">
                    ...
                    <article class="fullContainer custom-border">
                    ...
                    <form action="#" class="reg-enter">
                        ...
                        <div class="reg-options">
                            ...
                            <a href="#" class="link-to-registr transition">Регистрация</a>
                            <a href="#" class="link-to-pass transition">Вспомнить пароль</a>
                        </div>
                    </form>
                    <form action="#" class="reg-password">
                    ...
                    <form action="#" class="reg-registr">
                        <h2 class="hitches"><span>Сюрпризы</span></h2>
                        <p>
                            <span>Ваше имя:</span>
                            <input type="text"/>
                        </p>
