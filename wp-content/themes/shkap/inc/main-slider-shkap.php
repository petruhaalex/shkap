...
//  Add Custom Owl Slider Script
	function owl_script() {
    wp_register_script('owlscript', plugins_url('/main-slider-shkap/owl-carousel/owl.script.js'));
...
//  Slider Meta Box
	$slidelink_2_metabox = array( 
		...
		'fields' => array(
						...
						array(
						'name' 			=> __('Open slide link in new tab:','shkap'),
						'desc' 			=> '',
						'id' 			=> 'shkap_slidetarget',
						'class' 		=> 'shkap_slidetarget',
						'type' 			=> 'checkbox'
						),
					)
	);	
                            ...
                            <section class="custom-border big">
                                ...
                                <div class="carousel-container">
                                    <article class="pre-info">
                                        ...
                                        <?php
                                            if ( get_post_meta( get_the_id(), 'shkap_slideurl', true) != '' ) { ?>
